...
export const projects: Project[] = [
  {
    slug: "quickcart",
    title: "QuickCart",
    description: "A multi-sided delivery platform with real-time order tracking, driver dispatch, and Razorpay payments across customer, driver, store, and admin roles.",
    highlights: [
    ...
    image: "/quickcart-cover.png",
    githubUrl: "https://github.com/adil2133-git/QuickCart",
  },
  {
    slug: "futgen",
    title: "FUTGEN",
    description: "A football-themed e-commerce platform with JWT authentication, Razorpay payments, and CI/CD deployment to AWS and Vercel.",
    highlights: [
